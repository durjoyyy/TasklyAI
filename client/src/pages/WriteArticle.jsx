...
const WriteArticle = () => {
  const articleLength = [
    { length: 500, text: "Short(400-500 words)" },
    { length: 750, text: "Medium(600-750 words)" },
    ...
    >
        ...
        <div className="mt-3 flex gap-3 flex-wrap sm:max-w-9/11">
          {articleLength.map((item, index) => (
            <span
              ...
              className={`text-xs px-4 py-1 border border-gray-300 rounded-full cursor-pointer ${
      ...
      border-gray-200 min-h-96 max-h-[600px]">
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="text-sm flex flex-col items-center gap-5 terxt-gray-400">
