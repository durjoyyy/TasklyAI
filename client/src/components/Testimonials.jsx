...
const Testimonials = () => {
    const cardsData = [
        {
            ...
            handle: '@priyacreates',
            date: 'April 20, 2025',
            review: 'Taskly has completely changed the way I manage projects—simple, smart, and super reliable!'
        },
        {
            ...
            handle: '@danielcodes',
            date: 'May 10, 2025',
            review: 'Before Taskly, I wasted hours on repetitive tasks. Now everything is automated and smooth.'
        },
        {
            ...
            handle: '@sophiawrites',
            date: 'June 5, 2025',
            review: 'Taskly feels like having a personal assistant. It helps me stay ahead of deadlines effortlessly.'
        },
        {
            ...
            handle: '@arjunbiz',
            date: 'July 12, 2025',
            review: 'I use Taskly daily for my startup—it saves me at least 5 hours a week. Couldn’t imagine working without it.'
        },
    ];
    ...
    return (
        ...
        `}</style>
            ...
            <h2 className="text-3xl font-bold text-gray-800 mt-10">What People Say About Taskly</h2>
            <p className="text-gray-600 mb-6">Real users share how Taskly helps them save time and get more done.</p>
